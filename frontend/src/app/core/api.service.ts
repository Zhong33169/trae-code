...
export class ApiService {
  ...
  createBatch(payload: { action: ActionType; taskIds: number[]; evidence: string }): Promise<{ batch: Batch; items: BatchItem[] }> {
  ...
  retryBatch(id: number, payload: { itemIds: number[]; evidence: string }): Promise<{ batch: Batch; items: BatchItem[] }> {
