...
系统预置了 8 张巡检单，覆盖各种业务场景：

| 单号 | 器械 | 状态 | 风险 | 场景 |
|------|------|------|------|------|
| INSP-202606200001 | 跑步机-01 | 已归档 | 低 | ✅ 正常通过 |
| INSP-202606200002 | 椭圆机-01 | 待复核 | 中 | ❌ 异常，已报修 |
| INSP-202606200003 | 动感单车-01 | 待办理 | 高 | ⚠️ 高风险，缺证据 |
| INSP-202606200004 | 高位下拉-01 | 已退回 | 中 | ↩️ 退回补正 |
| INSP-202606200005 | 哑铃-01 | 已归档 | 高 | ⏰ 逾期，有故障和恢复记录，已修复归档 |
| INSP-202606200006 | 史密斯架-01 | 办理中 | 中 | 🔄 状态冲突 |
| INSP-202606200007 | 跑步机-01 | 待办理 | 低 | 新发起巡检 |
| INSP-202606200008 | 高位下拉-01 | 待复核 | 中 | 🔁 **退回后重新办理**（低→中风险升级、故障报修+恢复确认闭环、上一轮退回意见保留） |
