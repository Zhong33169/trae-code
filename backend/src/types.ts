...
export const StatusQueueMap: Record<HarvestStatus, Role> = {
  [HarvestStatus.DRAFT]: Role.FIELD_ADMIN,
  [HarvestStatus.SUBMITTED]: Role.TECHNICIAN,
  [HarvestStatus.PENDING_CORRECTION]: Role.FIELD_ADMIN,
  [HarvestStatus.VERIFIED]: Role.COOP_DIRECTOR,
  [HarvestStatus.PENDING_REVIEW]: Role.COOP_DIRECTOR,
  [HarvestStatus.ARCHIVED]: Role.COOP_DIRECTOR,
  [HarvestStatus.REJECTED]: Role.FIELD_ADMIN,
};
