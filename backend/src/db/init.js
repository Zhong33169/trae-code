...
const insertApp = db.prepare(`
  INSERT OR IGNORE INTO applications (
    ...
    is_timeout, sla_due_at, sample_case, offline_expected_issue, created_at
  ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
...
insertApp.run('APP001', 'BATCH202501001', '北京燃气公司第一分公司', '北京市朝阳区建国路88号', 'OLD-001', 'NEW-A001', '到期更换', 'pending_supervisor', 1, null, null, 0, null, null, 0, '2025-01-11', 'normal', null, '2025-01-10 09:00:00');
...
insertApp.run('APP002', 'BATCH202501001', '北京燃气公司第二分公司', '北京市海淀区中关村大街1号', 'OLD-002', 'NEW-A002', '故障更换', 'pending_archivist', 1, 2, null, 0, null, null, 0, '2025-01-14', 'normal', null, '2025-01-11 10:00:00');
...
insertApp.run('APP003', 'BATCH202501002', '北京燃气公司第三分公司', '北京市西城区金融街15号', 'OLD-003', 'NEW-A003', '到期更换', 'pending_operator', 1, 2, null, 0, null, '退回原因：缺少旧表照片和换表现场记录，请补正后重新提交', 0, '2025-01-13', 'rejected', null, '2025-01-11 11:00:00');
...
insertApp.run('APP004', 'BATCH202501004', '北京燃气公司第四分公司', '北京市东城区王府井大街100号', 'OLD-004', 'NEW-A004', '故障更换', 'pending_supervisor', 1, null, null, 0, null, '缺材料：未上传新表安装记录和现场照片，待审核主管核验退回', 0, '2025-01-15', 'missing_materials', null, '2025-01-12 14:00:00');
...
insertApp.run('APP005', 'BATCH202501003', '北京燃气公司第五分公司', '北京市丰台区南三环西路16号', 'OLD-005', 'NEW-A005', '到期更换', 'archived', 1, 2, 3, 1, null, '正常归档完成，全流程示例', 0, '2025-01-13', 'normal', null, '2025-01-11 15:00:00');
...
insertApp.run('APP006', 'BATCH202501006', '北京燃气公司第六分公司', '北京市石景山区八角西街66号', 'OLD-006', 'NEW-A006', '到期更换', 'pending_archivist', 1, 2, null, 0, null, '超时：待归档已超过 SLA（应于2025-01-14完成）', 1, '2025-01-14', 'timeout', null, '2025-01-09 08:00:00');
...
insertApp.run('APP007', 'BATCH202501007', '北京燃气公司第七分公司', '北京市通州区新华西街58号', 'OLD-007', 'NEW-A007', '故障更换', 'pending_archivist', 1, 2, null, 0, null, '离线台账无此记录，归档将校验失败', 0, '2025-01-16', 'offline_missing', 'offline_missing', '2025-01-13 09:00:00');
...
insertApp.run('APP008', 'BATCH202501008', '北京燃气公司第八分公司', '北京市昌平区回龙观西大街118号', 'OLD-008', 'NEW-A008', '到期更换', 'pending_archivist', 1, 2, null, 0, null, '状态不一致：线下台账已作废，归档将校验失败', 0, '2025-01-16', 'status_inconsistency', 'status_inconsistency', '2025-01-13 10:00:00');
...
insertApp.run('APP009', 'BATCH202501009', '北京燃气公司第九分公司', '北京市顺义区府前东街11号', 'OLD-009', 'NEW-A009', '到期更换', 'archived', 1, 2, 3, 1, null, '正常归档（批次已占用，用于制造 APP010 批次冲突）', 0, '2025-01-20', 'normal', null, '2025-01-14 09:00:00');
...
insertApp.run('APP010', 'BATCH202501009', '北京燃气公司第十分公司', '北京市大兴区兴政街20号', 'OLD-010', 'NEW-A010', '故障更换', 'pending_archivist', 1, 2, null, 0, null, '重复批次：与 APP009 同批次但表号不同，归档将校验失败', 0, '2025-01-20', 'batch_conflict', 'batch_conflict', '2025-01-15 09:00:00');
