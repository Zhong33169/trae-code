...
export const expenses = [
  ...
  makeExpense({
    ...
    createdAt: now - 7 * day,
    updatedAt: now - 3 * day,
    lastResult: '核验通过，但材料不全（缺1项），待经理酌情复核',
    lastHandler: 'u2',
    lastHandleTime: now - 3 * day,
    exceptionReason: '已逾期 2 天，加急处理中；材料不全（缺少：行程单），请经理酌情处理',
    ...
    auditLogs: [
      ...
      { id: 'a25', action: 'verify_pass', userId: 'u2', userName: '李会计', time: now - 3 * day, remark: '核验通过：酒店发票和账单齐全，但缺行程单，且已逾期，请经理尽快复核决定，材料状态：缺少：行程单' },
    ],
  }),
];
