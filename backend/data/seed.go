...
func SeedData() error {
	...
	logs := []models.OperationLog{
		...
		{OrderID: 3, Operation: "补充证据-补录", OldStatus: models.StatusReturned, NewStatus: models.StatusReturned, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "上传证据: 折价审批单.pdf，备注: 补录：折价处理审批单"},
		{OrderID: 3, Operation: "移动补录-调整原因", OldStatus: models.StatusReturned, NewStatus: models.StatusReturned, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "运输破损: 补充了物流破损照片链接和损坏件数"},
		{OrderID: 3, Operation: "移动补录-备注补充", OldStatus: models.StatusReturned, NewStatus: models.StatusReturned, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "仓库负责人签字确认: 已加签破损处理意见"},
		{OrderID: 4, Operation: "提交核验", OldStatus: models.StatusReturned, NewStatus: models.StatusResubmitted, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "补录完成，重新提交核验（版本号已更新）"},
		{OrderID: 4, Operation: "移动补录-效期信息", OldStatus: models.StatusReturned, NewStatus: models.StatusReturned, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "旧效期2025-12 → 新效期2026-06，批号已重新录入"},
		{OrderID: 4, Operation: "补充证据-登记", OldStatus: models.StatusPendingSubmit, NewStatus: models.StatusPendingSubmit, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "上传证据: 效期证明.jpg，备注: 商品效期照片"},
		{OrderID: 8, Operation: "补充证据-补录", OldStatus: models.StatusReturned, NewStatus: models.StatusReturned, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "上传证据: 补发快递单.jpg，备注: 补录：补发商品快递单"},
		{OrderID: 8, Operation: "移动补录-备注补充", OldStatus: models.StatusReturned, NewStatus: models.StatusReturned, OperatorID: users[1].ID, OperatorName: users[1].RealName, OperatorRole: users[1].Role, Remark: "补发单号SF1234567890: 客户已签收确认"},
		{OrderID: 5, Operation: "补充证据-核验", OldStatus: models.StatusPendingVerify, NewStatus: models.StatusPendingVerify, OperatorID: users[2].ID, OperatorName: users[2].RealName, OperatorRole: users[2].Role, Remark: "上传证据: 核验报告.pdf，备注: 仓储主管核验报告"},
		{OrderID: 6, Operation: "补充证据-核验", OldStatus: models.StatusPendingVerify, NewStatus: models.StatusPendingVerify, OperatorID: users[2].ID, OperatorName: users[2].RealName, OperatorRole: users[2].Role, Remark: "上传证据: 损耗核验记录.xlsx，备注: 核验记录"},
		{OrderID: 7, Operation: "补充证据-核验", OldStatus: models.StatusPendingVerify, NewStatus: models.StatusPendingVerify, OperatorID: users[2].ID, OperatorName: users[2].RealName, OperatorRole: users[2].Role, Remark: "上传证据: 入库验收单.jpg，备注: 重新入库验收照片"},
		{OrderID: 7, Operation: "补充证据-复核", OldStatus: models.StatusPendingReview, NewStatus: models.StatusPendingReview, OperatorID: users[3].ID, OperatorName: users[3].RealName, OperatorRole: users[3].Role, Remark: "上传证据: 复核确认单.pdf，备注: 运营经理复核确认"},
		{OrderID: 8, Operation: "补充证据-核验", OldStatus: models.StatusPendingVerify, NewStatus: models.StatusPendingVerify, OperatorID: users[2].ID, OperatorName: users[2].RealName, OperatorRole: users[2].Role, Remark: "上传证据: 核验意见.pdf，备注: 主管核验意见"},
		{OrderID: 8, Operation: "补充证据-复核", OldStatus: models.StatusPendingReview, NewStatus: models.StatusPendingReview, OperatorID: users[3].ID, OperatorName: users[3].RealName, OperatorRole: users[3].Role, Remark: "上传证据: 复核意见书.pdf，备注: 经理复核意见"},
