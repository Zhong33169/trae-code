...
INSERT INTO operation_records (id, appeal_id, operator_id, operator_name, operator_role, action, opinion, from_status, to_status, created_at) VALUES
    ('r1', 'a1', 'u1', '张登记', 'registrar', 'submit', '经核查，来访人陈明的登记信息与系统记录存在不一致，已上传佐证材料，提请审核处理', '', 'pending_review', '2026-01-15T09:00:00'),
    ('r2', 'a1', 'u2', '李审核', 'reviewer', 'approve', '已核对登记材料与系统记录，差异情况属实，证据材料充分有效，同意提交复核', 'pending_review', 'pending_recheck', '2026-01-15T16:00:00'),
    ('r3', 'a1', 'u3', '王复核', 'rechecker', 'approve', '复核确认登记信息异常情况属实，已按流程完成异常登记归档处理', 'pending_recheck', 'archived', '2026-01-16T14:30:00'),

    ('r4', 'a2', 'u1', '张登记', 'registrar', 'submit', '来访人林芳未能提供身份证原件及预约凭证等必要证明材料，按缺证类型提交审核', '', 'pending_review', '2026-02-20T10:30:00'),

    ('r5', 'a3', 'u1', '张登记', 'registrar', 'submit', '来访人赵强的登记申请超出规定办理时限2个工作日，已附超时情况说明，提请审核', '', 'pending_review', '2026-03-10T11:00:00'),
    ('r6', 'a3', 'u2', '李审核', 'reviewer', 'approve', '经核实超时原因系系统故障导致延迟，情况属实，相关说明材料齐全，同意提交复核', 'pending_review', 'pending_recheck', '2026-03-11T16:00:00'),

    ('r7', 'a4', 'u1', '张登记', 'registrar', 'submit', '来访人周丽的登记信息中联系电话填写不完整，工作单位信息缺失，已提交初步材料', '', 'pending_review', '2026-04-05T14:00:00'),
    ('r8', 'a4', 'u2', '李审核', 'reviewer', 'return', '登记信息不完整：1.联系电话缺区号无法核实；2.工作单位未填写；3.缺少来访事由说明。请补充完整上述信息后重新提交', 'pending_review', 'returned', '2026-04-06T09:00:00'),

    ('r9', 'a5', 'u1', '张登记', 'registrar', 'submit', '系统显示来访人吴刚已办理完成，但实际未完成签字确认环节，系统状态与实际办理情况不符，已提交情况说明', '', 'pending_review', '2026-05-12T08:30:00'),
    ('r10', 'a5', 'u2', '李审核', 'reviewer', 'approve', '已核实系统日志与办理记录，确认存在状态不同步问题，情况属实，提请复核裁定', 'pending_review', 'pending_recheck', '2026-05-13T15:00:00'),
    ('r11', 'a5', 'u3', '王复核', 'rechecker', 'reject', '复核认为：系统状态差异系来访人中途离场未完成全部流程导致，不属于系统异常范畴，不符合异常登记受理条件，予以驳回。建议按正常流程重新办理登记', 'pending_recheck', 'rejected', '2026-05-14T10:00:00');
"""
