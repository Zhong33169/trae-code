...
def seed_data():
    ...
    audit_data = [
        (1, "create", 1, "registrar", "张三", "登记员创建不良事件", now, None, None, 1, None, "draft", None, None, None, None),
        (2, "create", 1, "registrar", "张三", "登记员创建事件上报", now, None, None, 1, None, "draft", None, None, None, None),
        (2, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (3, "create", 1, "registrar", "张三", "登记员创建整改追踪", now, None, None, 1, None, "draft", None, None, None, None),
        (3, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (3, "review_pass", 2, "supervisor", "李四", "审核主管通过审核", now, None, 2, 3, "submitted", "review_passed", None, None, None, None),
        (4, "create", 1, "registrar", "张三", "登记员创建不良事件", now, None, None, 1, None, "draft", None, None, None, None),
        (4, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (4, "review_reject", 2, "supervisor", "李四", "审核主管退回：材料不完整", now, None, 2, 3, "submitted", "review_rejected", None, None, None, None),
        (5, "create", 1, "registrar", "张三", "登记员创建事件上报", now, None, None, 1, None, "draft", None, None, None, None),
        (5, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (5, "review_pass", 2, "supervisor", "李四", "审核主管通过审核", now, None, 2, 3, "submitted", "review_passed", None, None, None, None),
        (5, "archive_reject", 3, "reviewer", "王五", "复核负责人退回：防控措施不到位", now, None, 3, 4, "review_passed", "archive_rejected", None, None, None, None),
        (6, "create", 1, "registrar", "张三", "登记员创建不良事件", now, None, None, 1, None, "draft", None, None, None, None),
        (6, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (6, "review_pass", 2, "supervisor", "李四", "审核主管通过审核", now, None, 2, 3, "submitted", "review_passed", None, None, None, None),
        (6, "archive", 3, "reviewer", "王五", "复核负责人归档", now, None, 3, 4, "review_passed", "archived", None, None, None, None),
        (7, "create", 1, "registrar", "张三", "登记员创建事件上报", now, None, None, 1, None, "draft", None, None, None, None),
        (7, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (8, "create", 1, "registrar", "张三", "登记员创建整改追踪", now, None, None, 1, None, "draft", None, None, None, None),
        (8, "submit", 1, "registrar", "张三", "登记员提交事件", now, None, 1, 2, "draft", "submitted", None, None, None, None),
        (8, "review_pass", 2, "supervisor", "李四", "审核主管通过审核", now, None, 2, 3, "submitted", "review_passed", None, None, None, None),
        (None, "filter_change", 1, "registrar", "张三", "筛选变更：岗位=医疗事件登记员；状态=草稿", now, None, None, None, None, None, None, "registrar", "draft", None),
        (None, "filter_change", 2, "supervisor", "李四", "筛选变更：岗位=医疗事件审核主管", now, None, None, None, None, None, None, "supervisor", None, None),
        (None, "filter_change", 1, "registrar", "张三", "筛选变更：岗位=医疗事件登记员；类型=不良事件", now, None, None, None, None, None, None, "registrar", None, "adverse_event"),
        (None, "filter_change", 3, "reviewer", "王五", "筛选变更：岗位=三甲医院医务部复核负责人；状态=审核通过", now, None, None, None, None, None, None, "reviewer", "review_passed", None),
        (None, "filter_change", 1, "registrar", "张三", "清除所有筛选", now, None, None, None, None, None, None, None, None, None),
    ]
    c.executemany(
