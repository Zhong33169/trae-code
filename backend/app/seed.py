    ...
    try:
        ...
        if db.query(InspectionOrder).count() == 0:
            ...
            order1 = InspectionOrder(
                ...
                inspection_remark="跑步机日常巡检，设备使用频率高，需重点关注跑带磨损情况",
            ...
            order2 = InspectionOrder(
                ...
                inspection_remark="椭圆机电磁控阻力系统异常，会员反映无法调节阻力档位",
            ...
            order3 = InspectionOrder(
                ...
                inspection_remark="动感单车脚踏板金属断裂外露，高风险，需立即停用并设置警示标识",
                version=1,
            ...
            order4 = InspectionOrder(
                ...
                maintenance_check=True,
                inspection_remark="高位下拉训练器钢索磨损，初次检查后被退回要求补充证据",
            ...
            order5 = InspectionOrder(
                ...
                maintenance_check=True,
                inspection_remark="5kg哑铃手柄松动+螺栓缺失，高风险安全隐患，已逾期完成但已修复归档",
            ...
            order6 = InspectionOrder(
                ...
                safety_check=True,
                maintenance_check=True,
                inspection_remark="史密斯架办理中出现状态冲突（操作人与当前处理人不一致），需先解除冲突",
                version=1,
            ...
            order7 = InspectionOrder(
                ...
                inspection_remark="跑步机日常巡检，新发起，待办理",
                version=1,
                created_at=now,
                updated_at=now,
            )
            ...
            order8 = InspectionOrder(
                ...
                inspection_remark="高位下拉训练器退回后重新办理，已升级中风险，存在钢丝绳卡滞故障",
