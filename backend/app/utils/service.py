...
def _dict_to_application(row: tuple, evidences: Optional[List] = None) -> Dict:
    return {
        ...
        "current_handler_name": row[21] if len(row) > 21 and row[21] else None,
        "current_handler_role": row[22] if len(row) > 22 and row[22] else None,
        "version": row[11],
        ...
        return [
            {
                ...
                "operator_id": r[2],
                "operator_role": r[3],
                "operator_name": r[13] if len(r) > 13 else None,
                "operation_type": r[4],
                "from_stage": r[5],
                "to_stage": r[6],
                "from_status": r[7],
                ...
                "version_before": r[14] if len(r) > 14 else None,
                "version_after": r[15] if len(r) > 15 else None,
                "created_at": datetime.fromisoformat(r[16]),
            }
            for r in rows
        ]
    finally:
        ...
        return [
            {
                ...
                "operator_id": r[2],
                "operator_role": r[3],
                "operator_name": r[8] if len(r) > 8 else None,
                "from_level": r[4],
                "to_level": r[5],
                "change_reason": r[6],
