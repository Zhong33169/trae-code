...
func MustSeed(db *sql.DB) {
	...
	tasks := []seedTask{
		// T1 草稿 + 登记证据齐备：可被客户经理提交（成功）【客户经理无驳回入口：草稿状态】
		{"RT-2026-0001", "PA202600011", "上海明远贸易（客户经理无驳回入口）", "企业财产综合险", "标准续保", 12800, 13500,
			StatusDraft, 1, cmID, RoleCustomerManager,
			regEv("保单到期前30天续保，客户确认保额无变化，上传近三年赔付记录。【客户经理无驳回入口：草稿状态】", "陈经理", cmID, "2026-06-15 09:12:00"), sql.NullString{}, sql.NullString{}},
		// T2 草稿 + 登记证据缺失（缺证据）
		...
		// T9 已提交（核保手）：核保专员可驳回样例【核保可驳回】
		{"RT-2026-0009", "PA202600101", "天津海昌物流（核保可驳回）", "货物运输险", "扩项续保", 56000, 62000,
			StatusSubmitted, 1, cmID, RoleUnderwritingSpecialist,
			regEv("新增冷藏运输线路，但风险评估报告未附上。【核保可驳回样例】", "陈经理", cmID, "2026-06-16 11:05:00"), sql.NullString{}, sql.NullString{}},
		// T10 已复核（业务负责人手）：业务负责人可驳回样例【负责人可驳回】
		{"RT-2026-0010", "PA202600115", "重庆璧山制造（负责人可驳回）", "机器损坏险", "费率调整", 42000, 45000,
			StatusReviewed, 1, cmID, RoleBusinessOwner,
			regEv("上年出险2次，今年费率上浮5%，客户同意。【负责人可驳回样例】", "陈经理", cmID, "2026-06-15 09:00:00"),
			regEv("费率上浮依据可量化，但赔付凭证未附。", "林专员", usID, "2026-06-17 14:20:00"), sql.NullString{}},
		// T11 已复核（但因为操作延迟仍挂在核保专员名下）：业务负责人尝试驳回会 FORBIDDEN_ROLE——错角色失败样例【错角色失败】
		{"RT-2026-0011", "PA202600128", "西安大兴建材（错角色失败）", "建筑工程一切险", "标准续保", 96000, 96000,
			StatusReviewed, 1, cmID, RoleUnderwritingSpecialist,
			regEv("续保持平，工地安全无事故。【错角色失败样例：reviewed 流转未转岗】", "陈经理", cmID, "2026-06-14 08:35:00"),
